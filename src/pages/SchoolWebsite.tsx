    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-br from-blue-600 to-purple-700 text-white">
        <div className="container mx-auto px-6 py-20">
          <div className="text-center">
            <h1 className="text-5xl font-bold mb-6">Professional School Websites</h1>
      ...
      <div className="container mx-auto px-6 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose Our School Website Development?</h2>
        ...
        {/* Packages */}
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">School Website Packages</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
        ...
        <div className="text-center mt-16 bg-white rounded-lg shadow-sm p-8">
          ...
          <p className="text-gray-600 mb-6">Contact us today to discuss your school website needs</p>
