      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          {levels.map((level, index) => (
            <Card key={level.title} className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-2 cursor-pointer">
        ...
        <div className="text-center mt-12">
          <div className="inline-flex items-center space-x-4 bg-white rounded-full px-6 py-3 shadow-md">
            ...
            <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm font-medium">Public Schools</span>
            <span className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-sm font-medium">Private Schools</span>
          </div>
        </div>
      </div>
    </section>
